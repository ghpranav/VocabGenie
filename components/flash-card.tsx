              ...
              <div className="flex items-center w-full mb-4">
                <form onSubmit={handleSubmit}>
                  <div className="relative">
                    <Input
                      value={prompt}
                      className="w-full pl-4 pr-8 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent hover:ring-2 hover:ring-black transition-all duration-300 ease-in-out shadow-lg hover:shadow-xl dark:bg-white dark:placeholder-gray-500 dark:text-gray-800"
